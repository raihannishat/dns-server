...
- আমার সার্ভার গুলো Oracle VirtualBox এর মধ্যে vm এ রান করবে এবং আমার প্রাইমারি OS হলো Windows 11, যেখানে Oracle VirtualBox এর মধ্যে ১ টা মাস্টার সার্ভার এবং ২ টা স্লেভ সার্ভার থাকবে। আমি vm এর ভিতরে Ubuntu 24.04.2 LTS ব্যবহার করেছি।
